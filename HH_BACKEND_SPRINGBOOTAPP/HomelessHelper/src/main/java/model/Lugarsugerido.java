 ...
 */
@Entity
@NamedQuery(name = "Lugarsugerido.findAll", query = "SELECT l FROM Lugarsugerido l")
public class Lugarsugerido implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "id_lugar_sugerido")
	private int idLugarsugerido;
	...
	public Lugarsugerido() {
	}

	public int getIdLugarsugerido() {
		return this.idLugarsugerido;
	}

	public void setIdLugarsugerido(int idLugarsugerido) {
		this.idLugarsugerido = idLugarsugerido;
	}
